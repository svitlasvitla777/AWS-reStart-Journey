...
| Domain | Technologies |
|---|---|
| AWS Cloud | EC2 · S3 · IAM · VPC · RDS · Lambda · CloudWatch |
| Linux | Command line · Permissions · System navigation |
| Python | Automation basics · Cloud scripting |
...
| 7 | Monitoring & Logging | CloudWatch, metrics, alerts, system visibility | Coming Soon |
| 8 | Automation & Serverless | Lambda, event-driven architecture | Coming Soon |
| 9 | Infrastructure & DevOps | Infrastructure concepts, version control, automation | Coming Soon |
| 10 | Security & Compliance | Cloud security frameworks and governance | Coming Soon |
| 11 | Cost Management | AWS pricing models and cost optimisation strategies | Coming Soon |
| 12 | Final Project & Certification Prep | Applying everything together | Coming Soon |
